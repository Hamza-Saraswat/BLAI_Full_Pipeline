[Skip to content](https://github.com/sgharlow/skillcrossroads#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/sgharlow/skillcrossroads) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/sgharlow/skillcrossroads) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/sgharlow/skillcrossroads) to refresh your session.Dismiss alert

{{ message }}

[sgharlow](https://github.com/sgharlow)/ **[skillcrossroads](https://github.com/sgharlow/skillcrossroads)** Public

- [Notifications](https://github.com/login?return_to=%2Fsgharlow%2Fskillcrossroads) You must be signed in to change notification settings
- [Fork\\
0](https://github.com/login?return_to=%2Fsgharlow%2Fskillcrossroads)
- [Star\\
2](https://github.com/login?return_to=%2Fsgharlow%2Fskillcrossroads)


main

[**10** Branches](https://github.com/sgharlow/skillcrossroads/branches) [**2** Tags](https://github.com/sgharlow/skillcrossroads/tags)

[Go to Branches page](https://github.com/sgharlow/skillcrossroads/branches)[Go to Tags page](https://github.com/sgharlow/skillcrossroads/tags)
...
[![sgharlow](https://avatars.githubusercontent.com/u/8032920?v=4&size=40)](https://github.com/sgharlow)[sgharlow](https://github.com/sgharlow/skillcrossroads/commits?author=sgharlow)

[gates: record the 2026-09-17 Show HN post, and the attribution gap it…](https://github.com/sgharlow/skillcrossroads/commit/01fa6fb34cb662ab2334d1019a53cf49c16bf94e)

Open commit detailssuccess

7 hours agoSep 18, 2026

[01fa6fb](https://github.com/sgharlow/skillcrossroads/commit/01fa6fb34cb662ab2334d1019a53cf49c16bf94e) · 7 hours agoSep 18, 2026

## History

[158 Commits](https://github.com/sgharlow/skillcrossroads/commits/main/)

Open commit details

[View commit history for this file.](https://github.com/sgharlow/skillcrossroads/commits/main/) 158 Commits

## Folders and files

| Name | Name | Last commit message | Last commit date |
| --- | --- | --- | --- |
| [.claude-plugin](https://github.com/sgharlow/skillcrossroads/tree/main/.claude-plugin ".claude-plugin") | [.claude-plugin](https://github.com/sgharlow/skillcrossroads/tree/main/.claude-plugin ".claude-plugin") |  |  |
| [.github](https://github.com/sgharlow/skillcrossroads/tree/main/.github ".github") | [.github](https://github.com/sgharlow/skillcrossroads/tree/main/.github ".github") |  |  |
| [apps](https://github.com/sgharlow/skillcrossroads/tree/main/apps "apps") | [apps](https://github.com/sgharlow/skillcrossroads/tree/main/apps "apps") |  |  |
| [docs](https://github.com/sgharlow/skillcrossroads/tree/main/docs "docs") | [docs](https://github.com/sgharlow/skillcrossroads/tree/main/docs "docs") |  |  |
| [packages](https://github.com/sgharlow/skillcrossroads/tree/main/packages "packages") | [packages](https://github.com/sgharlow/skillcrossroads/tree/main/packages "packages") |  |  |
| [plugin](https://github.com/sgharlow/skillcrossroads/tree/main/plugin "plugin") | [plugin](https://github.com/sgharlow/skillcrossroads/tree/main/plugin "plugin") |  |  |
| [reports](https://github.com/sgharlow/skillcrossroads/tree/main/reports "reports") | [reports](https://github.com/sgharlow/skillcrossroads/tree/main/reports "reports") |  |  |
| [scripts](https://github.com/sgharlow/skillcrossroads/tree/main/scripts "scripts") | [scripts](https://github.com/sgharlow/skillcrossroads/tree/main/scripts "scripts") |  |  |
| [.env.example](https://github.com/sgharlow/skillcrossroads/blob/main/.env.example ".env.example") | [.env.example](https://github.com/sgharlow/skillcrossroads/blob/main/.env.example ".env.example") |  |  |
| [.gitignore](https://github.com/sgharlow/skillcrossroads/blob/main/.gitignore ".gitignore") | [.gitignore](https://github.com/sgharlow/skillcrossroads/blob/main/.gitignore ".gitignore") |  |  |
| [.vercelignore](https://github.com/sgharlow/skillcrossroads/blob/main/.vercelignore ".vercelignore") | [.vercelignore](https://github.com/sgharlow/skillcrossroads/blob/main/.vercelignore ".vercelignore") |  |  |
| [CLAUDE.md](https://github.com/sgharlow/skillcrossroads/blob/main/CLAUDE.md "CLAUDE.md") | [CLAUDE.md](https://github.com/sgharlow/skillcrossroads/blob/main/CLAUDE.md "CLAUDE.md") |  |  |
| [LICENSE](https://github.com/sgharlow/skillcrossroads/blob/main/LICENSE "LICENSE") | [LICENSE](https://github.com/sgharlow/skillcrossroads/blob/main/LICENSE "LICENSE") |  |  |
| [PROJECT.yaml](https://github.com/sgharlow/skillcrossroads/blob/main/PROJECT.yaml "PROJECT.yaml") | [PROJECT.yaml](https://github.com/sgharlow/skillcrossroads/blob/main/PROJECT.yaml "PROJECT.yaml") |  |  |
| [README.md](https://github.com/sgharlow/skillcrossroads/blob/main/README.md "README.md") | [README.md](https://github.com/sgharlow/skillcrossroads/blob/main/README.md "README.md") |  |  |
| [ROADMAP.md](https://github.com/sgharlow/skillcrossroads/blob/main/ROADMAP.md "ROADMAP.md") | [ROADMAP.md](https://github.com/sgharlow/skillcrossroads/blob/main/ROADMAP.md "ROADMAP.md") |  |  |
| [SETUP.md](https://github.com/sgharlow/skillcrossroads/blob/main/SETUP.md "SETUP.md") | [SETUP.md](https://github.com/sgharlow/skillcrossroads/blob/main/SETUP.md "SETUP.md") |  |  |
| [next.md](https://github.com/sgharlow/skillcrossroads/blob/main/next.md "next.md") | [next.md](https://github.com/sgharlow/skillcrossroads/blob/main/next.md "next.md") |  |  |
| [package-lock.json](https://github.com/sgharlow/skillcrossroads/blob/main/package-lock.json "package-lock.json") | [package-lock.json](https://github.com/sgharlow/skillcrossroads/blob/main/package-lock.json "package-lock.json") |  |  |
| [package.json](https://github.com/sgharlow/skillcrossroads/blob/main/package.json "package.json") | [package.json](https://github.com/sgharlow/skillcrossroads/blob/main/package.json "package.json") |  |  |
| [tsconfig.base.json](https://github.com/sgharlow/skillcrossroads/blob/main/tsconfig.base.json "tsconfig.base.json") | [tsconfig.base.json](https://github.com/sgharlow/skillcrossroads/blob/main/tsconfig.base.json "tsconfig.base.json") |  |  |
| [vitest.config.ts](https://github.com/sgharlow/skillcrossroads/blob/main/vitest.config.ts "vitest.config.ts") | [vitest.config.ts](https://github.com/sgharlow/skillcrossroads/blob/main/vitest.config.ts "vitest.config.ts") |  |  |
| View all files |
...
[Permalink: Why](https://github.com/sgharlow/skillcrossroads#why)
...
[Permalink: Install & use](https://github.com/sgharlow/skillcrossroads#install--use)
...
[Permalink: Share the result](https://github.com/sgharlow/skillcrossroads#share-the-result)
...
[Permalink: Fix suggestions (--suggest, BYOK)](https://github.com/sgharlow/skillcrossroads#fix-suggestions---suggest-byok)

Grading tells you _what's wrong_; `--suggest` proposes _how to fix it_. With your Anthropic key
...
[Permalink: What a report looks like](https://github.com/sgharlow/skillcrossroads#what-a-report-looks-like)
...
[ai-coding](https://github.com/topics/ai-coding) [badge](https://github.com/topics/badge) [ci](https://github.com/topics/ci) [claude-code](https://github.com/topics/claude-code) [code-quality](https://github.com/topics/code-quality) [linting](https://github.com/topics/linting) [mcp](https://github.com/topics/mcp) [skills](https://github.com/topics/skills)

### Resources

[Readme](https://github.com/sgharlow/skillcrossroads#readme-ov-file)

[MIT license](https://github.com/sgharlow/skillcrossroads#MIT-1-ov-file)

[Activity](https://github.com/sgharlow/skillcrossroads/activity)
...
[**0** forks](https://github.com/sgharlow/skillcrossroads/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fsgharlow%2Fskillcrossroads&report=sgharlow+%28user%29)
