[Skip Navigation](https://scottspence.com/posts/claude-code-skills-dont-auto-activate#main-content)

[Scott Spence](https://scottspence.com/)

🐱Choose a theme:Select a themeacidaquaautumnblackbumblebeebusinesscmykcoffeecorporatecupcakecyberpunkdarkdimdraculaemeraldfantasygardenhalloweenlemonadelightlofiluxurynightnordpastelretrosunsetsynthwavetealixvalentinewinterwireframe

[Posts](https://scottspence.com/posts) [Tags](https://scottspence.com/tags) [Speaking](https://scottspence.com/speaking) [Contact](https://scottspence.com/contact)

# Claude Code Skills Don't Auto-Activate (a workaround)

November 5, 2025 • 8 min read

[claude](https://scottspence.com/tags/claude) [claude-code](https://scottspence.com/tags/claude-code) [guide](https://scottspence.com/tags/guide) [notes](https://scottspence.com/tags/notes)

[1 person viewing now](https://scottspence.com/stats)

Hey! Thanks for stopping by! Looks like this post was updated 5 days ago. Just bear in mind it was originally posted 11 months ago. If there's anything in here which doesn't make sense, [please get in touch.](https://scottspence.com/contact)

So I got Claude Skills to register with Claude Code (sorted the [YAML formatting issue](https://scottspence.com/posts/claude-code-skills-not-recognised)),
and the skills are now showing up when I ask Claude to list them. Job
done, right? Nah! Turns out getting skills to _actually activate_ **reliably** when you need them is another chore in itself.

**Update, 13 September 2026:** This was my first workaround. I later [tested hooks for more reliable skill activation](https://scottspence.com/posts/how-to-make-claude-code-skills-activate-reliably),
...
that”, Claude should use the global skill (located in `~/.claude/skills/research/`) which has instructions to verify
...
“study” as trigger words. According to the [official docs](https://docs.claude.com/en/docs/claude-code/skills),
...
## [The investigation](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#the-investigation)
...
## [“Hey Claude is there a skill for this?”](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#hey-claude-is-there-a-skill-for-this)
...
## [A workaround](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#a-workaround)

I’d already come across the [claude-code-infrastructure-showcase](https://github.com/diet103/claude-code-infrastructure-showcase) repository when researching for my [claude-skills-cli](https://github.com/spences10/claude-skills-cli) in
...
Here’s what I got to work - call a script via the `UserPromptSubmit` hook that detects trigger words and **explicitly tells Claude to use**
**the skill**.

## [The hook script](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#the-hook-script)
...
## [Add the hook to settings](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#add-the-hook-to-settings)
...
## [Key differences from a reminder](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#key-differences-from-a-reminder)
...
## [The results](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#the-results)
...
## [How hooks actually work](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#how-hooks-actually-work)

Quick note on the hook format, as I was dicking around with this
making [analytics tools via the statusline in the past](https://github.com/spences10/claude-code-analytics).
...
## [Why this matters](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#why-this-matters)
...
## [Pattern for other skills](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#pattern-for-other-skills)
...
## [The scalability problem](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#the-scalability-problem)
...
(like [claude-skills-cli](https://github.com/spences10/claude-skills-cli))
...
## [Update: A simpler, more scalable approach](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#update-a-simpler-more-scalable-approach)

After more testing with the [claude-skills-cli](https://github.com/spences10/claude-skills-cli),
...
A single, hook with an **explicit instruction** that works for _all_ skills:
...
## [Does this work better?](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#does-this-work-better)
...
## [What I actually found from testing](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#what-i-actually-found-from-testing)
...
## [Bottom line](https://scottspence.com/posts/claude-code-skills-dont-auto-activate\#bottom-line)
...
love to know - hit me up on [Bluesky](https://bsky.app/profile/scottspence.dev).
...
There's a [reactions leaderboard](https://scottspence.com/reactions-leaderboard) you can check out too.

[Useful? Share it on Bluesky.](https://bsky.app/intent/compose?text=Check%20out%20this%20post%20from%20@scottspence.dev,%20Claude%20Code%20Skills%20Don%27t%20Auto-Activate%20(a%20workaround):%20https://scottspence.com/posts/claude-code-skills-dont-auto-activate)

[✨ View the stats for this post ✨](https://scottspence.com/stats/claude-code-skills-dont-auto-activate)

## Replies on Bluesky

[Say something ↗](https://bsky.app/profile/scottspence.dev/post/3m4xbanfwrk2s)

No replies yet. You could be the first.

Take a look at some popular content from me... Views todayViews this monthViews this year
...
Stuck? [Troubleshoot](https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/g/turnstile/f/av0/rch/v28rg/0x4AAAAAAB7B-TdXwl1NxA3R/auto/fbE/new/flexible?lang=auto#refresh)

Success!

Verification failed

[Troubleshoot](https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/g/turnstile/f/av0/rch/v28rg/0x4AAAAAAB7B-TdXwl1NxA3R/auto/fbE/new/flexible?lang=auto#refresh)

Verification expired

[Refresh](https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/g/turnstile/f/av0/rch/v28rg/0x4AAAAAAB7B-TdXwl1NxA3R/auto/fbE/new/flexible?lang=auto#refresh)
...
I care about the protection of your data. Read the [Privacy Policy](https://scottspence.com/privacy-policy) for more info.

Back to top

Copyright © 2017 - 2026 - All rights
reserved
Scott Spence