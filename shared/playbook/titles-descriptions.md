...
- Hard limit 100 characters; about 50-60 show in search and feeds, about 40 in the mobile Shorts feed. Target: long-form 35-65 characters, Shorts 40 visible characters.
- Primary keyword inside the first 40 characters. Important words first, branding or episode numbers last.
...
- Long-form: the chapters block (`00:00 Intro` first, at least 3 lines, each at least 10 s apart, ascending), links, credits, then 2-3 hashtags at the end. 800-2,000 characters.
- Shorts: first line names the related long-form video (or the channel's closest one), 2-3 hashtags, no chapter block.
...
Pinned comment, end screens and cards, the Shorts "related video" link to the long-form episode, Test & Compare thumbnails, community posts. The publish stage sends these as a Telegram checklist.
