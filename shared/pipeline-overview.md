...
| Host | Runs | Writes |
|------|------|--------|
| Cloud routine (claude.ai/code) | Shorts stages 01-05 | markdown and JSON outputs, hub notes; pushes `main` |
| DGX Spark build agent (`build/`) | Shorts stages 06-08 | `-voice.md`, `-render.md`, `-publish.md`; hub note status; pushes `main` |
...
| `scripted` | stage 04 (cloud) | package |
...
| The script reads wrong, sounds off, or repeats last week's shape | script stage (04) |
